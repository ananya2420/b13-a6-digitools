...
const Footer = () => {
  return (
    <footer className="bg-black-500 text-gray-700">
      ...
      <div className="bg-gray-200 border-t border-gray-300 py-4 px-6 lg:px-20">
